#ifndef BITBOARD_CONSTANTS_H_
#define BITBOARD_CONSTANTS_H_

#include "chess.h" // For BIT() and square enums
...
#define RANKS2TO7 (~(RANK1 | RANK8))

// used for castling checks
#define F1G1 (BIT(F1) | BIT(G1))
#define C1D1 (BIT(C1) | BIT(D1))
#define B1D1 (BIT(B1) | BIT(C1) | BIT(D1))

#define F8G8 (BIT(F8) | BIT(G8))
#define C8D8 (BIT(C8) | BIT(D8))
#define B8D8 (BIT(B8) | BIT(C8) | BIT(D8))

// used to update castle flags
#define WHITE_KING_SIDE_ROOK  BIT(H1)
#define WHITE_QUEEN_SIDE_ROOK BIT(A1)
#define BLACK_KING_SIDE_ROOK  BIT(H8)
#define BLACK_QUEEN_SIDE_ROOK BIT(A8)
