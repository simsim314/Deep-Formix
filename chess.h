...
#define QUEEN   5
#define KING    6
#define EMPTY_SQUARE 0 // <--- ADDED MISSING DEFINITION

// Magic lookup table constants
...
struct BoardPosition
{
    union
    {
        ...
        uint8 board[128]; // For easy access to the whole board
    };
};
...
public:
    ...
    CUDA_CALLABLE_MEMBER uint8 getFrom() const { return m_Move & 0x3F; }
    CUDA_CALLABLE_MEMBER uint8 getTo() const { return (m_Move >> 6) & 0x3F; }
    CUDA_CALLABLE_MEMBER uint8 getFlags() const { return (m_Move >> 12) & 0xF; }
...
struct CompactPosRecord
{
    ...
    **************************************/
    ...
    // implementations moved to compact_pos_record.cu
